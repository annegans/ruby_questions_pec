...
def select_elements_starting_with_vowel(array)
  array.select { |string| string.start_with?('a', 'e', 'i', 'o')}
...
def average_of_array(array)
  array.inject{ |sum, el| sum + el }.to_f.round / array.size
end
